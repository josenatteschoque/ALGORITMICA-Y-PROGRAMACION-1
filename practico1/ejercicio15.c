/*Ejercicio 15. Escriba un programa que permita ingresar una letra L e imprima todas la letras del abecedario en
orden alfabético desde la letra a ( o A) hasta L. Tenga en cuenta si el usuario ingresó una letra minúscula o
